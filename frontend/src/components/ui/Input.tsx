      ...
      <div className="w-full">
        ...
        <div className="relative">
          <input
            ...
            id={inputId}
            className={cn(
              'focus-ring h-10 w-full rounded-xl border bg-white px-3 text-[13px] text-ink-800 placeholder:text-ink-400 transition-colors dark:bg-ink-900 dark:text-ink-100',
              error
