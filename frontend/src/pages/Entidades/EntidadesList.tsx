      ...
      case 'acoes':
        return (
          <div className="flex items-center justify-center gap-1">
            ...
            <IconBtn title="Editar" onClick={() => onEditar(ent)}>
              <Pencil className="h-4 w-4" />
            </IconBtn>
            <IconBtn title={ent.ativo ? 'Inativar' : 'Reativar'} danger={ent.ativo} onClick={() => onAlternarStatus(ent)}>
            ...
            {carregando ? (
              ...
              <tr>
                <td colSpan={colunas.length} className="py-16 text-center">
                  ...
                  <p className="mt-2 text-sm text-ink-500 dark:text-ink-400">Nenhuma entidade encontrada.</p>
                </td>
              </tr>
            ) : (
              data.map((ent) => (
