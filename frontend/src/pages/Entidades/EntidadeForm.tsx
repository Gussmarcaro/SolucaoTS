      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-12">
          ...
          <fieldset className="rounded-xl border border-ink-200 px-3 pb-3 pt-1 dark:border-ink-700 sm:col-span-12">
            <legend className="px-1 text-[13px] font-normal text-ink-600 dark:text-ink-300">Finalidade Estatutária</legend>
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-12">
          ...
          {/* Estatuto */}
          <fieldset className="rounded-xl border border-ink-200 px-3 pb-3 pt-1 dark:border-ink-700 sm:col-span-12">
            <legend className="px-1 text-[13px] font-normal text-ink-600 dark:text-ink-300">Estatuto</legend>
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-12">
