...
- **Cartão da Agenda**, entre as contagens e os prazos — os próximos 7 dias e o que ficou sem registro. Compromisso é a única coisa do sistema com **hora marcada**: prazo se cumpre até o fim do dia, reunião começa às 14h30. Fica logo antes do prazo da prestação porque ler o dia antes do ano é a ordem natural. Reusa `GET /compromissos` com a mesma janela e a **mesma visibilidade** da tela da Agenda — consulta própria seria a chance de o Dashboard mostrar o particular que a Agenda esconde.
