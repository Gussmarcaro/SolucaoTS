...
import { DevolucaoUseCases } from '@/application/devolucao/DevolucaoUseCases';
import { PrismaDevolucaoRepository } from '@/infrastructure/database/PrismaDevolucaoRepository';
import { PrismaPrestacaoRepository } from '@/infrastructure/database/PrismaPrestacaoRepository';

const casos = new DevolucaoUseCases(new PrismaDevolucaoRepository(), new PrismaPrestacaoRepository());
