...
import { DescontoUseCases } from '@/application/desconto/DescontoUseCases';
import { PrismaDescontoRepository } from '@/infrastructure/database/PrismaDescontoRepository';
import { PrismaPrestacaoRepository } from '@/infrastructure/database/PrismaPrestacaoRepository';

const casos = new DescontoUseCases(new PrismaDescontoRepository(), new PrismaPrestacaoRepository());
