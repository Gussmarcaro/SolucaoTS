...
import { EmpregadoUseCases } from '@/application/empregado/EmpregadoUseCases';
import { PrismaEmpregadoRepository } from '@/infrastructure/database/PrismaEmpregadoRepository';
import { PrismaPrestacaoRepository } from '@/infrastructure/database/PrismaPrestacaoRepository';

const casos = new EmpregadoUseCases(new PrismaEmpregadoRepository(), new PrismaPrestacaoRepository());
