...
import { ServidorPrestacaoUseCases } from '@/application/servidorPrestacao/ServidorPrestacaoUseCases';
import { PrismaServidorPrestacaoRepository } from '@/infrastructure/database/PrismaServidorPrestacaoRepository';
import { PrismaPrestacaoRepository } from '@/infrastructure/database/PrismaPrestacaoRepository';

const casos = new ServidorPrestacaoUseCases(
  new PrismaServidorPrestacaoRepository(),
  new PrismaPrestacaoRepository(),
);

export class ServidorPrestacaoController {
