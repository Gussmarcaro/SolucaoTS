...
import { EmpenhoPrestacaoUseCases } from '@/application/empenhoPrestacao/EmpenhoPrestacaoUseCases';
...
const casos = new EmpenhoPrestacaoUseCases(
  new PrismaEmpenhoPrestacaoRepository(),
  new PrismaPrestacaoRepository(),
);

export class EmpenhoPrestacaoController {
